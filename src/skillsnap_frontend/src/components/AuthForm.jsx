...
const AuthForm = () => {
  ...
  const handleICPLogin = () => {
    ...
    const handleMessage = (event) => {
      if (event.origin === 'https://identity.ic0.app' && event.data) {
        ...
        // Handle the identity data (e.g., store in state or redirect)
  ...
  return (
    <div className="relative min-h-screen bg-transparent text-white overflow-hidden flex items-center justify-center font-sans">
      ...
      <div className={`relative z-10 ${isLogin ? 'w-[500px] h-[550px] p-6' : 'w-[560px] h-[611px] p-8'} bg-[#313131] rounded-2xl shadow-xl border border-white/20 font-['Inter'] flex flex-col`}>
        ...
        <div className="space-y-3 mt-4">
          ...
          >
            <ICPIcons className="w-4 h-4" /> {isLogin ? 'Connect' : 'Register'} with Internet Identity
          </button>
...
{isLogin ? 'Connect' : 'Register'} Wallet
        ...
        <div className="text-center mt-3">
          <Link to="/register" className="text-blue-400 hover:underline text-xs">
