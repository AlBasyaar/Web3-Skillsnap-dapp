...
import { FaPlug, FaWallet, FaFingerprint, FaTimes, FaEthereum } from 'react-icons/fa';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md relative">
        ...
        <div className="space-y-4">
          ...
          {/* Disclaimer Text */}
          <p className="text-xs text-gray-500 dark:text-gray-400 text-center mt-4 px-2">
            By connecting a wallet, you agree to Skillsnap Terms of Service and acknowledge that you have read and understand the Skillsnap disclaimer
          </p>
        </div>
