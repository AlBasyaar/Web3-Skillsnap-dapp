...
const FeatureCard = ({ icon, title, description, buttonText, onClick, disabled = false }) => (
  <div className="bg-gray-900/80 backdrop-blur-sm p-6 rounded-xl border border-gray-700/50 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-purple-500/50">
    ...
    <button
      onClick={onClick}
      disabled={disabled}
      className={`px-4 py-2 rounded-lg font-medium transition-all ${disabled 
...
const Web3 = () => {
  ...
  const verifySkills = () => {
    // In a real app, this would verify skills on the blockchain
    alert('Verifying your skills on the blockchain...');
  };
      ...
      <div className="max-w-6xl mx-auto bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-800 overflow-hidden">
        <div className="border-b border-gray-800">
          <nav className="flex -mb-px">
            <button
              onClick={() => setActiveTab('skills')}
              className={`py-4 px-6 text-center border-b-2 font-medium text-sm ${activeTab === 'skills' 
            ...
            <button
              onClick={() => setActiveTab('reputation')}
              className={`py-4 px-6 text-center border-b-2 font-medium text-sm ${activeTab === 'reputation' 
                ? 'border-purple-500 text-purple-400' 
                : 'border-transparent text-gray-400 hover:text-gray-200'}`}
            >
              Reputation
          ...
          {!connected ? (
            ...
            <div className="space-y-4">
              ...
              {[
                ...
                <div key={index} className="flex items-start p-4 bg-gray-800/30 rounded-xl border border-gray-700/50 hover:bg-gray-800/50 transition-colors">
