...
import { idlFactory } from './skillsnap_backend.did.js';
export { idlFactory } from './skillsnap_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SKILLSNAP_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./skillsnap_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the skillsnap_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./skillsnap_backend.did.js")._SERVICE>}
 */
export const skillsnap_backend = createActor(canisterId);
