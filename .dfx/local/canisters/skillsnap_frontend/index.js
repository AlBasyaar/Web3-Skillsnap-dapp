...
import { idlFactory } from './skillsnap_frontend.did.js';
export { idlFactory } from './skillsnap_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SKILLSNAP_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./skillsnap_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the skillsnap_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./skillsnap_frontend.did.js")._SERVICE>}
 */
export const skillsnap_frontend = createActor(canisterId);
